...
bool InterfaceManager::readMotorState( dynamixel_control_items_t item_id,
...
bool InterfaceManager::readDynamixelRegister( uint8_t id, uint16_t addr,
...
bool InterfaceManager::doSyncRead(
